...
public final class FileWriter {
    private static /* synthetic */ void $closeResource(Throwable a, AutoCloseable a2) {
        if (a == null) {
            a2.close();
            return;
        }
        try {
            ...
            a.addSuppressed((Throwable)throwable);
            return;
        }
    }
     ...
     */
    public static void writeLines(File a, Collection<String> a) throws IOException {
