...
public class UseItemPacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public void onPacketReceiving(PacketEvent a) {
        UseItemPacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.USE_ITEM, (PacketEvent)a);
    }

    public UseItemPacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.USE_ITEM});
        UseItemPacketAdapter a3;
        a3.checker = a2;
    }
}
