...
public class TabCompletePacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public void onPacketReceiving(PacketEvent a) {
        TabCompletePacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.TAB_COMPLETE, (PacketEvent)a);
    }

    public TabCompletePacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.TAB_COMPLETE});
        TabCompletePacketAdapter a3;
        a3.checker = a2;
    }
}
