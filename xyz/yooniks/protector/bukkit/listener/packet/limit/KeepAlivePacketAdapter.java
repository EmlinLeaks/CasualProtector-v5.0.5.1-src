...
public class KeepAlivePacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public KeepAlivePacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.KEEP_ALIVE});
        KeepAlivePacketAdapter a3;
        a3.checker = a2;
    }

    public void onPacketReceiving(PacketEvent a) {
        KeepAlivePacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.KEEP_ALIVE, (PacketEvent)a);
    }
}
