...
public class BlockDigPacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public void onPacketReceiving(PacketEvent a) {
        BlockDigPacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.BLOCK_DIG, (PacketEvent)a);
    }

    public BlockDigPacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.BLOCK_DIG});
        BlockDigPacketAdapter a3;
        a3.checker = a2;
    }
}
