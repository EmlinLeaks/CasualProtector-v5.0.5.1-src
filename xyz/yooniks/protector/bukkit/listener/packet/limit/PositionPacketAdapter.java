...
public class PositionPacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public PositionPacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.POSITION});
        PositionPacketAdapter a3;
        a3.checker = a2;
    }

    public void onPacketReceiving(PacketEvent a) {
        PositionPacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.POSITION, (PacketEvent)a);
    }
}
