...
public class AbilitiesPacketAdapter
extends PacketAdapter {
    private final PacketChecker checker;

    public AbilitiesPacketAdapter(Plugin a, PacketChecker a2) {
        super((Plugin)a, (PacketType[])new PacketType[]{PacketType.Play.Client.ABILITIES});
        AbilitiesPacketAdapter a3;
        a3.checker = a2;
    }

    public void onPacketReceiving(PacketEvent a) {
        AbilitiesPacketAdapter a2;
        a2.checker.checkThrough((SpamType)SpamType.ABILITIES, (PacketEvent)a);
    }
}
