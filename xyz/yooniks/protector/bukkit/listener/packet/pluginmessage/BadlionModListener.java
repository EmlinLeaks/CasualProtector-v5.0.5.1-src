...
extends CustomPluginMessageListener {
    ...
    public void onPacketReceiving(PacketEvent a) {
        ...
        if (!((String)object).equalsIgnoreCase((String)"badlion:mods")) return;
        a.setCancelled((boolean)true);
        a2.connectionCloser.closeConnection((Player)player, (String)MessagesConfig.BLOCK$LITELOADER);
    }
}
